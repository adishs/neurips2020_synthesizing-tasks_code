...
def prune_using_shortest_path_hoc(taskfilepath, maxnumblocks, verbose = 0):
...
if __name__ == "__main__":
    task_file = "../data/ignore/data/in_tasks/tasks/in-hoc-A_task.txt"
    #task_file = "/Users/gahana/Dropbox/problemgen_data_adishs-dropbox/temp/Ahana/shortest-path-test-files/dummy.txt"

    prune_flag = prune_using_shortest_path_hoc(task_file, 5)
    print(prune_flag)
