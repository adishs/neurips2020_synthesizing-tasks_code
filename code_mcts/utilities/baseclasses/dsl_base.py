...
class Dsl(object):
    def __init__(self, rng=None, min_int=0, max_int=19,
        ...
        # todo some attributes might need to be shifted from dsl to parser
        self.call_counter = [0]
    ...
    def lex_to_idx(self, code, details=False):
        # todo this function is not used - can remove it? and corresponding 
        # instance variables above like idx_to_token?

        tokens = [] 
        # todo need to change to program.lex_tokens or something similar
    ...
    # todo need to understand and check random_code and random_tokens funcs
    # Func random_code will be overriden in derived classes to return
    # code data stored in a Program class object
    ...
    # todo can we check for syntax errors without executing on empty world,
    # i.e., through parsing only
    # todo will syntax errors be found on branches outside execution trace?
